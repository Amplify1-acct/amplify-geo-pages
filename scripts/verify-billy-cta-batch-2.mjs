// Read-only saved-content and live-HTML verification for CTA rollout batch two.
import fs from 'node:fs';
import assert from 'node:assert/strict';
import {parseDocument} from 'htmlparser2';
import {findAll,textContent,removeElement} from 'domutils';
const root='/Users/matthewsalvato/Documents/New project/wordpress-backups/billy-cta-batch-2-2026-09-04';
const ids=process.argv.slice(2).map(Number);
const selected=ids.length?ids:[349,351,345,343,201,3944,3955,3957,3959,3936];
