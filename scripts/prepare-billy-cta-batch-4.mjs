...
const root='/Users/matthewsalvato/Documents/New project/wordpress-backups/billy-cta-batch-4-2026-09-04';
...
for(const spec of specs){
 ...
 const headings=findAll(e=>e.name==='h2'&&!isInsideDetails(e),dom.children);
 ...
 out.push({id:spec.id,label:spec.label,url:before.permalink,featuredMedia:publicBefore.featured_media,image:spec.image,portrait,practiceUrl:site+spec.practice,content,insertions});
}
