// Read-only saved-content and live-HTML verification for CTA rollout batch four.
...
const selected=ids.length?ids:[3990,3992,3994,3998,4000,4002,4004,4006,4009,4011];
