...
const root='/Users/matthewsalvato/Documents/New project/wordpress-backups/billy-cta-batch-5-2026-09-04';
...
for(const spec of specs){
 ...
 const headings=findAll(e=>e.name===(spec.headingTag||'h2')&&!isInsideDetails(e),dom.children);
 ...
 out.push({id:spec.id,language:spec.language,practiceText:spec.practiceText,callLabel:spec.language==='es'?'Llame al (914) 730-5789':'Call (914) 730-5789',label:spec.label,url:before.permalink,featuredMedia:publicBefore.featured_media,image:spec.image,portrait,practiceUrl:site+spec.practice,content,insertions});
}
